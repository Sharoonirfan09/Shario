...
export const services: Service[] = [
  {
    ...
    whatWeDoAr: [
      ...
      "التسويق عبر منصات التواصل الاجتماعي على ميتا (فيسبوك وإنستغرام)",
    ...
    whatWeDoRu: [
      ...
      "Продвижение в соцсетях через Meta (Facebook и Instagram)",
  ...
  },
  {
    ...
    descriptorAr:
      "استراتيجية العلامة التجارية، وأنظمة الهوية البصرية، ومرئيات الحملات، والمحتوى الإبداعي، بجودة تليق بإطلاق العلامة التجارية.",
    descriptorRu:
      "Стратегия бренда, системы айдентики, визуалы для кампаний и креатив, созданные на уровне готовности к запуску.",
