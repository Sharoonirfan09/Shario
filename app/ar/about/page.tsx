...
const descriptionAr =
  "شاريو وكالة تسويق رقمي واستوديو إبداعي في دبي، تربط بين الإعلانات المدفوعة وتحسين محركات البحث والعلامة التجارية والاستشارات التسويقية في نظام واحد للشركات الطموحة.";
      ...
      <Band>
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p
            ...
            data-delay="80"
          >
            تجمع شاريو بين الاستراتيجية والتسويق الرقمي وتحسين محركات البحث
        ...
        <div className="grid items-center gap-12 wide:grid-cols-[1fr_1.05fr] wide:gap-20">
          ...
          <div>
            ...
            <p className="reveal mt-6 max-w-[560px] text-[1.0625rem] leading-[1.7] text-carbon/75">
              مسوّقة رقمية واستراتيجية نمو رقمي، تركز على بناء علامات تجارية
