...
/** Path/crop live in `lib/site.ts` as `heroImages.contact`, shared with the Arabic page and both locales' `opengraph-image.tsx`. */
export const HERO_IMAGE = heroImages.contact.src;
