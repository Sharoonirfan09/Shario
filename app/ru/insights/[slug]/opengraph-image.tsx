...
/** Every article's own featured image and topic — never the site-wide default, and never another article's image. Limited to articles with a Russian edition, matching the page route this image belongs to. */
...
export async function generateImageMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return article ? [{ id: 0, alt: article.imageAltRu ?? article.imageAlt, contentType: ogContentType }] : [];
}
